...
namespace Fakestore.Models
{
    class CustomerService
    {
        public bool checkUsername(Customer c)
        {
            ...
            {
                bool check = false;
                string connString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=FakestoreDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
